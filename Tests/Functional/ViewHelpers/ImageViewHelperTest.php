...
class ImageViewHelperTest extends AbstractFunctionalTest
{
    ...
    public function canRenderImage()
    {
        $expectedAttributes = [
            ...
            'data-sizes' => 'auto',
            'data-srcset' => 'fileadmin/_processed_/c/e/csm_nightlife-4_f57e82a72e.jpg 200w,fileadmin/_processed_/c/e/csm_nightlife-4_f298794b55.jpg 400w',
            'src' => 'fileadmin/_processed_/c/e/csm_nightlife-4_65104e5a2d.jpg',
            'width' => 600,
            'height' => 375,
            'alt' => '',
        ];
